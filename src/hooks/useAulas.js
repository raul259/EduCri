...
const DEFAULT_AULAS = [
  ...
  { id: 4, name: 'Sala Cuna',      category: 'sala_cuna',      teacher: 'Prof. Cuna',     classroom: 'Sala SC', day: 'Domingo',   time: '10:00', description: '', pdfName: 'temario_sala_cuna.pdf',      pdfPath: null, color: 'from-green-400 to-teal-400' },
]
